...
Pass --physics-hz to override the default Pegasus physics rate (250 Hz). All sensor
update rates scale with physics_dt automatically.
...
Run:
  ./python.sh benchmarking/2_cube_pegasus_flat_no_px4.py                       # 250 Hz (default)
  ./python.sh benchmarking/2_cube_pegasus_flat_no_px4.py --physics-hz 100
  ./python.sh benchmarking/2_cube_pegasus_flat_no_px4.py --physics-hz 50
