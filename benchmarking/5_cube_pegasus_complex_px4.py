...
Combines the Full Warehouse scene (heaviest env) with the PX4 MAVLink lockstep loop.
This is the worst-case scenario; comparing against benchmarks 3 and 4 shows whether
scene complexity + PX4 compound or are independent.
...
Run:
  ./python.sh benchmarking/5_cube_pegasus_complex_px4.py                       # 250 Hz (default)
  ./python.sh benchmarking/5_cube_pegasus_complex_px4.py --physics-hz 100
  ./python.sh benchmarking/5_cube_pegasus_complex_px4.py --physics-hz 50
